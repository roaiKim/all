...
export interface ModuleLifecycleListener<RouteParam extends object = object> {
    onEnter: (parms: any, location: Location) => void | Promise<void>;
    onDestroy: () => void | Promise<void>;
    onLocationMatched: (routeParameters: RouteParam, location: Location) => void | Promise<void>;
...
> implements ModuleLifecycleListener<RouteParam> {
    ...
    onEnter(parms: any, location: Location) {
        /**
    ...
    onLocationMatched(routeParam: RouteParam, location: Location) {
        /**
