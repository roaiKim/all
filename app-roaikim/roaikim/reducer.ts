...
export function idleReducer(
    state: IdleState = { timeout: DEFAULT_IDLE_TIMEOUT, state: "active" },
    action: Action<IdleStateActionPayload | IdleTimeoutActionPayload>
): IdleState {
...
// Root Reducer
export function rootReducer(routerReducer: Reducer<RouterState, any>): Reducer<State, Action<any>, object> {
