// import { all as rawAll, call as rawCall, delay, type Effect, fork, put, race as rawRace, spawn, type StrictEffect } from "redux-saga/effects";
...
//     effects: [T1, T2, T3]
// ): SagaGeneratorWithReturn<[UnwrapReturnType<T1>?, UnwrapReturnType<T2>?, UnwrapReturnType<T3>?]>;
// export function race<T1, T2, T3, T4>(
//     effects: [T1, T2, T3, T4]
// ): SagaGeneratorWithReturn<[UnwrapReturnType<T1>?, UnwrapReturnType<T2>?, UnwrapReturnType<T3>?, UnwrapReturnType<T4>?]>;
...
//     [UnwrapReturnType<T1>?, UnwrapReturnType<T2>?, UnwrapReturnType<T3>?, UnwrapReturnType<T4>?, UnwrapReturnType<T5>?, UnwrapReturnType<T6>?]
// >;
