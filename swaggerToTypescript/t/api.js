...
function generateService(serviceName, operations) {
    ...
    operations.forEach(operation => {
        ...
        lines.push(`public static ${operation.name}(${parameterSignature}): Promise<${checkType(operation.responseType)}>{`);
